...
<body>
  <div class="main-content">
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../assets/img/background.jpg); background-size: cover; background-position: center top;">
      <!-- Mask -->
            ...
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="editprofile.php" class="btn btn-sm btn-primary">Edit</a>
                </div>
              </div>
            </div>
            <div class="card-body">
